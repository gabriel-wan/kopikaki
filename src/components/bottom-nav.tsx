...
export type Tab = "home" | "schedule" | "kakis";

export function BottomNav({ active, onChange }: { active: Tab; onChange: (tab: Tab) => void }) {
  const items = [{ id: "home" as const, label: "Home", Icon: Home }, { id: "schedule" as const, label: "Schedule", Icon: CalendarDays }, { id: "kakis" as const, label: "Kakis", Icon: Users }];
